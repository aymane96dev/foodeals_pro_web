          ...
          <div class="col-sm-12">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Nouveau Type de Restaurant</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                  <label for="name1" class="col-form-label">Nom de type de restaurant :</label>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit"  class="btn btn-primary" v-on:click="addtype"> Submit</button>
                            </div>
                        </form>
                          </div>
                        </div>
                ...
                <div class="modal fade" id="modalmod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel1">Modification de Type de Restaurant</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            ...
                            <input type="hidden" disabled class="form-control" id="idt" name="id" required  :value="this.id">
                                <div class="form-group">
                                  <label for="name" class="col-form-label">Nom de type de restaurant :</label>
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal"> Close</button>
                              <button type="submit"  class="btn btn-primary"  @click="edittype()"> Update</button>
                            </div>
                        </form>
                          </div>
                        </div>
                ...
                <tbody >
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger" v-on:click="deletetype(list)"><i class="fas fa-trash-alt"></i> Supprimer</button>
                        </td>
                        </tr>
                </tbody>
            </table>
...
var app = new Vue({
    ...
    data:{
        ...
        methods: {
            ...
            {
              var self = this;
            axios.post('typeStore',{name : self.name, obs : self.obs})
                .then((res) => {
                    this.lists = res.data;
            ...
            axios.post('/edittype/' + id.value, {name: name_m.value, obs: obs_m.value})
                .then(res => {
                this.lists = res.data;
            ...
            deletetype:function(list)
            {
                ...
                axios.post('/deletetype/' + list.id)
                .then(res => {
                this.readlists();
                toastr.error('Bien supprimer');
                })
                .catch(error =>{
                    toastr.error('Ce type de restaurant ne peut pas être supprimer');
                    console.error(err)});
                }
                })
            }
